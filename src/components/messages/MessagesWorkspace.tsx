...
export function MessagesWorkspace({ initialChatId }: { initialChatId?: string }) {
  ...
  return (
    <div className="-mx-4 -my-6 flex h-[calc(100dvh-14rem)] flex-col overflow-hidden border-y border-border bg-[#efeae2] sm:-mx-6 lg:-mx-8 lg:h-[calc(100dvh-5.5rem)] lg:rounded-none lg:border-x-0">
