...
export function Footer() {
  ...
  const copy = {
    en:{tag:"Meet someone who understands where you come from — and where you\'re going.",sub:"Modern relationship intelligence, shaped for Sri Lankan lives around the world.",language:"Language",about:"About",discover:"Discover",stories:"Success Stories",pricing:"Pricing",support:"Support",contact:"Contact",safety:"Safety",access:"Accessibility",legal:"Legal",privacy:"Privacy",terms:"Terms",guidelines:"Community Guidelines",rights:"All rights reserved.",confidence:"Connect with clarity and confidence."},
    ...
    de:{tag:"Triff jemanden, der versteht, woher du kommst und wohin du möchtest.",sub:"Moderne Beziehungsintelligenz für Sri-Lankerinnen und Sri-Lanker weltweit.",language:"Sprache",about:"Über uns",discover:"Entdecken",stories:"Erfolgsgeschichten",pricing:"Preise",support:"Support",contact:"Kontakt",safety:"Sicherheit",access:"Barrierefreiheit",legal:"Rechtliches",privacy:"Datenschutz",terms:"Bedingungen",guidelines:"Community-Richtlinien",rights:"Alle Rechte vorbehalten.",confidence:"Mit Klarheit und Vertrauen verbinden."}
  }[language];
