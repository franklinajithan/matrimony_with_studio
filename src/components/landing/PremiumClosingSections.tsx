...
export function GlobalCommunityStory(){
 ...
 return <section ref={ref} className="relative h-[190svh] lg:h-[145svh] bg-[#FFFDFB] [scroll-snap-align:start] [scroll-snap-stop:always]">
