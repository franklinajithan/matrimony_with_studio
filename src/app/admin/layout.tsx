...
import { AdminMobileTabBar } from "./admin-mobile-tab-bar";
...
export default async function AdminLayout({ children }: { children: ReactNode }) {
  ...
  return <div className="flex min-h-screen flex-col bg-[#fafbfe] text-slate-900">
    <header className="sticky top-0 z-30 border-b border-slate-100 bg-white/95 shadow-[0_2px_16px_rgba(15,23,42,0.035)] backdrop-blur-xl">
      ...
      <div className="hidden md:block"><AdminNavigation /></div>
    </header>
    <main className="mx-auto w-full max-w-screen-2xl flex-1 px-4 py-6 pb-28 sm:px-6 sm:py-8 md:pb-8">{children}</main>
    <AdminMobileTabBar />
