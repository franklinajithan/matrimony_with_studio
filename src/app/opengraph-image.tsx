  ...
  return new ImageResponse(
    (
      ...
      >
        ...
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', textAlign: 'center', padding: '70px 110px' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: 18, fontSize: 62, fontWeight: 800, color: '#7027E8' }}>
            <span style={{ fontSize: 70 }}>♥</span>
            <span>CupidMatch</span>
          </div>
          <div style={{ marginTop: 30, fontSize: 54, lineHeight: 1.12, fontWeight: 750, color: '#24152f' }}>
            Find Your Perfect Match
          </div>
          <div style={{ marginTop: 24, fontSize: 27, color: '#66586d' }}>
            Meaningful matrimony connections for India & Sri Lanka
          </div>
          <div style={{ marginTop: 48, display: 'flex', gap: 16, fontSize: 22, color: '#7027E8', fontWeight: 600 }}>
