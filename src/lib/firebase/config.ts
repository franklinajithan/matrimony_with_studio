...
// import { Firestore, getFirestore } from "firebase/firestore"; // Uncomment if you need Firestore
// import { FirebaseStorage, getStorage } from "firebase/storage"; // Uncomment if you need Storage
